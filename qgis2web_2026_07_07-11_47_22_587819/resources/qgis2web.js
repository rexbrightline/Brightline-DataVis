...
map.getView().fit([-13689761.385922, 4522177.831838, -13555244.869657, 4609926.533844], map.getSize());
    ...
    element: (() => {
        ...
        if (255 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Final Disadvantaged Communities (DAC) tracts included in the Final CalEnviroScreen 5.0. CES 5.0 includes all tracts with 75th percentile scores (CES5 Final) and all tracts from CES 4.0 (CES4DACs), but does not include the original Draft 5.0 or 3.0 tracts.';
            }
