...
map.getView().fit([-13720224.117061, 4457279.153730, -13572853.384199, 4688142.298196], map.getSize());
    ...
    element: (() => {
        ...
        if (417 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Disadvantaged Communities (DAC) tracts included in the Final CalEnviroScreen 5.0 -- all tracts with 75th percentile scores (CES5 Final) and all scored tracts from CES 4.0 (CES4DACs). The Final version does not include Draft 5.0 or CES 3.0 tracts.<br /><br />Made for Brightline Defense July 2026. <br /><br />Note: this map does not include Tribal Areas or "Low Population High Pollution" tracts, which are included in the final CES 5.0.';
            }
